...
def process(cfg, opt):
    ...
    def save_thread():
        ...
        while True:
            ...
            det_preds, img0s_np, ll_masks, meta, (H, W) = item
            ...
            for i, (
                ...
                lane_mask = ll_masks[i].cpu().numpy()

                lane_color = np.zeros_like(img_det)

                lane_color[lane_mask == 1] = [255, 0, 0]

                img_det = cv2.addWeighted(
                    img_det,
                    1.0,
                    lane_color,
                    0.7,
