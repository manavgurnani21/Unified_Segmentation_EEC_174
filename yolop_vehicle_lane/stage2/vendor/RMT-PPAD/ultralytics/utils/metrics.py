...
class Metric(SimpleClass):
    ...
    def fitness(self):
        ...
        w = [0.0, 0.1, 0.9, 0.0]  # weights for [P, R, mAP@0.5, mAP@0.5:0.95]   ### JW we focus on recall and map50
...
class SegmentationMetric(object):       ### JW segmentation metrics reference https://github.com/JiayuanWang-JW/YOLOv8-multi-task/blob/32824bb90542bcd6d24831eec7c9c911b40c181f/ultralytics/yolo/utils/metrics.py#L535
    '''
