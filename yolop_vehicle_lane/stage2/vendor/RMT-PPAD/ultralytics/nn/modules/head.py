...
from .transformer import MLP, DeformableTransformerDecoder, DeformableTransformerDecoderLayer, TransformerSegmentationDecoder, CLRKDFusedSegmentationDecoder
...
class MTDETRDecoder(nn.Module):
    ...
    def __init__(
        ...
        self.num_queries = nq
        self.num_decoder_layers = ndl
        self.seg_decoder_name = seg_decoder
        ...
        self.imgsz = 640
        if seg_decoder == "clrkd_fpn":
            self.seg_head = CLRKDFusedSegmentationDecoder(hd, ns_classes)
        else:
