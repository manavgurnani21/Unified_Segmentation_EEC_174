"""Append exp56/57/58 entries to NB08. Idempotent."""
...
EVAL_ENTRIES = [
    ('exp56_rmt_gca_query64_dn_lane_only_joint', ['short20', 'debug', '']),
    ('exp57_rmt_gca_anchor_cls_sep_vfl_full_data_long12_joint', ['full12', 'debug', '']),
    ('exp58_rmt_gca_query64_dn_vfl_stable_joint', ['short20', 'debug', '']),
]
PLOT_TAG = {
    'exp56_rmt_gca_query64_dn_lane_only_joint': 'short20',
    'exp57_rmt_gca_anchor_cls_sep_vfl_full_data_long12_joint': 'full12',
    'exp58_rmt_gca_query64_dn_vfl_stable_joint': 'short20',
}
