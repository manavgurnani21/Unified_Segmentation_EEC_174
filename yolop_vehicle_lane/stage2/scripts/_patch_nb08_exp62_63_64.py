"""Append exp62/63/64 entries to NB08."""
...
EVAL_ENTRIES = [
    ('exp62_rmt_gca_anchor_cls_sep_vfl_iou_match_long14_joint', ['full14', 'debug', '']),
    ('exp63_rmt_gca_anchor_cls_sep_topk4_vfl_full_data_joint', ['full12', 'debug', '']),
    ('exp64_rmt_gca_anchor_cls_sep_vfl_long_warmup_full_data_joint', ['full14', 'debug', '']),
]
PLOT_TAG = {
    'exp62_rmt_gca_anchor_cls_sep_vfl_iou_match_long14_joint': 'full14',
    'exp63_rmt_gca_anchor_cls_sep_topk4_vfl_full_data_joint': 'full12',
    'exp64_rmt_gca_anchor_cls_sep_vfl_long_warmup_full_data_joint': 'full14',
}
...
def patch_plot(text):
    candidates = [
        "    '/content/drive/MyDrive/EcoCAR/training_runs/exp61_rmt_gca_anchor_cls_sep_vfl_iou_match_full_data_joint_full12_metrics.json',\n",
        "    '/content/drive/MyDrive/EcoCAR/training_runs/exp60_rmt_gca_anchor_cls_sep_topk3_vfl_full_data_joint_full12_metrics.json',\n",
        "    '/content/drive/MyDrive/EcoCAR/training_runs/exp59_rmt_gca_anchor_cls_sep_vfl_w1_full_data_joint_full8_metrics.json',\n",
