"""Append exp53/54/55 entries to NB08. Idempotent."""
...
EVAL_ENTRIES = [
    ('exp53_rmt_gca_anchor_cls_sep_topk3_vfl_joint', ['short20', 'debug', '']),
    ('exp54_rmt_gca_query64_dn_vfl_long_warmup_joint', ['short20', 'debug', '']),
    ('exp55_rmt_gca_anchor_vfl_full_data_long12_joint', ['full12', 'debug', '']),
]
PLOT_TAG = {
    'exp53_rmt_gca_anchor_cls_sep_topk3_vfl_joint': 'short20',
    'exp54_rmt_gca_query64_dn_vfl_long_warmup_joint': 'short20',
    'exp55_rmt_gca_anchor_vfl_full_data_long12_joint': 'full12',
}
...
def patch_plot(text):
    candidates = [
        "    '/content/drive/MyDrive/EcoCAR/training_runs/exp52_rmt_gca_anchor_vfl_full_data_bb_throttle_joint_full6_metrics.json',\n",
