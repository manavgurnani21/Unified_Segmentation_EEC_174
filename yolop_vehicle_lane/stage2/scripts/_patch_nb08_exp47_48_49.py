"""Append exp47/48/49 entries to NB08. Idempotent."""
...
EVAL_ENTRIES = [
    ('exp47_rmt_gca_anchor_topk_fixed_vfl_joint', ['short20', 'debug', '']),
    ('exp48_rmt_gca_query_anchor_dn_vfl_joint', ['short20', 'debug', '']),
    ('exp49_rmt_gca_anchor_topk_fixed_vfl_full_data_det_rescue_joint', ['full6', 'debug', '']),
]
PLOT_TAG = {
    'exp47_rmt_gca_anchor_topk_fixed_vfl_joint': 'short20',
    'exp48_rmt_gca_query_anchor_dn_vfl_joint': 'short20',
    'exp49_rmt_gca_anchor_topk_fixed_vfl_full_data_det_rescue_joint': 'full6',
}
...
def patch_plot(text):
    candidates = [
        ...
        "    '/content/drive/MyDrive/EcoCAR/training_runs/exp44_rmt_gca_hybrid_anchor_query_vfl_joint_short20_metrics.json',\n",
