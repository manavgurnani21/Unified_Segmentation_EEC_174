# built in script. runs at 8fps or so due to a CPU bottleneck. run with:
# python demo.py --weight 'weights/medium.pth' --source 'inputs/dashcam_rural.mp4' --config 'medium' --save-dir "outputs/florida.mp4" --img-size 640
